...
#pragma once
	...
	#error FKE_PLATFORM_WINDOWS not defined
#endif

#if defined(_MSC_VER) && _MSC_VER > 1929 
	#pragma message("Detected compiler newer than Visual Studio 2019, please update min version checking in Source/Runtime/fkecore/Public/WindowsPlatform/WindowsPlatformCompilerSetup.h")
#endif
...
static_assert(_MSC_VER < 1910 || _MSC_VER >= 1913, "Visual Studio 2017 version 15.6 is required to compile on Windows. Please install updates.");
static_assert(_MSC_VER != 1914 && _MSC_VER != 1915, "Visual Studio 2017 versions 15.7 and 15.8 are known to have code generation bugs that affect FKEngine. Please update to version 15.9.");

// Manually enable all warnings as errors, except ones that are explicitly skipped.
// Warnings that are explicitly disabled later are still included in there.
...
// 4312 - 'operation' : conversion from 'type1' to 'type2' of greater size_t															https://docs.microsoft.com/en-us/cpp/error-messages/compiler-warnings/compiler-warning-level-1-c4312
