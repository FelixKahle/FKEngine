...
namespace fkengine
{
	namespace fkecore
	{
		struct FKECORE_API log_msg
		{
			FKE_STATIC_STRUCT(log_msg)
	...
	#define FKE_LOG(category_name, type, format, ...) \
			FKE_LOG_EXPAND_IS_FATAL(type, \
				...
				{ \
					fkengine::fkecore::log_msg::logf_internal(FKE_LOG_SOURCE_FILE(__FILE__), __LINE__, log_type::fatal, l_format, FKE_LOG_args...); \
	...
	#define FKE_DECLARE_LOG_CATEGORY_EXTERN(category_name) \
			extern struct log_category##category_name : fkengine::fkecore::public log_category \
			{ \
	...
	#define FKE_DEFINE_LOG_CATEGORY_STATIC(category_name) \
			static struct log_category##category_name : public fkengine::fkecore::log_category \
			{ \
				FKE_FORCEINLINE log_category##category_name() : log_category(FKE_TEXT(#category_name)) {} \
			} category_name
	...
	#define FKE_LOG(category_name, type, format, ...) \
			{ \
				...
				{ \
					FKE_LOG_EXPAND_IS_FATAL(type, \
						{ \
							fkengine::fkecore::log_msg::logf_internal(FKE_LOG_SOURCE_FILE(__FILE__), __LINE__, l_category_name.get_name(), log_type::fatal, l_format, FKE_LOG_args...); \
							FKE_DEBUG_BREAK_AND_PROMPT_FOR_REMOTE(); \
						}, \
						{ \
							fkengine::fkecore::log_msg::logf_internal(nullptr, 0, l_category_name.get_name(), log_type::##type, l_format, FKE_LOG_args...); \
						} \
					) \
				}; \
	 ...
	 */
	#define FKE_DECLARE_LOG_CATEGORY_EXTERN(category_name) \
			extern struct log_category##category_name : public fkengine::fkecore::log_category \
			{ \
				FKE_FORCEINLINE log_category##category_name() : log_category(FKE_TEXT(#category_name)) {} \
			} category_name
