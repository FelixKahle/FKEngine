...
//
    ...
    #define FKE_TYPE_PRETTY_FUNCTION_PREFIX "basic_compile_time_string<char> fkengine::fke_nameof_private::pretty_function_type() [T = "
    #define FKE_TYPE_PRETTY_FUNCTION_SUFFIX "]"
#elif defined(__GNUC__) && !defined(__clang__)
    #define FKE_TYPE_PRETTY_FUNCTION_PREFIX "constexpr basic_compile_time_string<char> fkengine::fke_nameof_private::pretty_function_type() [with T = "
    #define FKE_TYPE_PRETTY_FUNCTION_SUFFIX "]"
#elif defined(_MSC_VER)
    #define FKE_TYPE_PRETTY_FUNCTION_PREFIX "class fkengine::basic_compile_time_string<char,struct std::enable_if<1,char> > __cdecl fkengine::fke_nameof_private::pretty_function_type<"
...
#define FKE_TYPE_PRETTY_FUNCTION_RIGHT (sizeof(FKE_TYPE_PRETTY_FUNCTION_SUFFIX) - 1)
    ...
    #define FKE_VALUE_PRETTY_FUNCTION_SUFFIX "]"
#elif defined(_MSC_VER)
    #define FKE_VALUE_PRETTY_FUNCTION_PREFIX "class fkengine::basic_compile_time_string<char,struct std::enable_if<1,char> > __cdecl fkengine::fke_nameof_private::pretty_function_value<"
    #define FKE_VALUE_PRETTY_FUNCTION_SEPARATOR "; T Value = "
...
namespace fkengine
{
    ...
    namespace fke_nameof_private
    {
        ...
        struct type_name_length : integral_constant<size_t, fkengine::nameof<t>().length()>
        {};

        template<typename r, typename tclass>
        struct type_name_length<r tclass::*, void> : integral_constant<size_t, fkengine::nameof<r tclass::*>().length()>
        {};

        template<typename tenum>
        struct type_name_length<tenum, typename enable_if<std::is_enum<tenum>::value>::type> : integral_constant<size_t, fkengine::nameof<tenum>().length()>
        {};
    ...
    FKE_CONSTEXPR compile_time_ansi_string nameof()
    {
        return fkengine::compile_time_nameof(type_tag<t>());
    }

    template<typename t, t val>
    FKE_CONSTEXPR compile_time_ansi_string nameof()
    {
        return fkengine::compile_time_nameof(static_value<t, val>());
    }

#ifdef FKE_HAS_VARIABLE_TEMPLATES
    template<typename t>
    FKE_CONSTEXPR compile_time_ansi_string nameof_v = fkengine::nameof<t>();

    template<typename t, t val>
    FKE_CONSTEXPR compile_time_ansi_string nameof_value_v = fkengine::nameof<t, val>();
#endif
}