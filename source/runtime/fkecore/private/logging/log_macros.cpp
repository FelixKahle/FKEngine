...
namespace fkengine
{
	...
	void log::logf_impl(const char_t* file, int32_t line, const char_t_string& category, log_type type, const char_t* fmt, ...)
	{
#if !FKE_NO_LOGGING
	...
	void log::logf_internal_impl(const char_t* file, int32_t line, const char_t_string& category, log_type type, const char_t* fmt, ...)
	{
#if !FKE_NO_LOGGING
		if (type != log_type::fatal)
		{
		...
		void log::logf_impl(const char_t * file, int32_t line, log_type type, const char_t * fmt, ...)
		{
#if !FKE_NO_LOGGING
			if (type != log_type::fatal)
			{
		...
		void log::logf_internal_impl(const char_t * file, int32_t line, log_type type, const char_t * fmt, ...)
		{
#if !FKE_NO_LOGGING
			if (type != log_type::fatal)
			{
